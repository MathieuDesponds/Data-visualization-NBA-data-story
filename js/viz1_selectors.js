export function showYearSelection(){
...
export function showPeriodForStatisticsSelection(){
...
export function showTeamsCheckbox(data){
  ...
  d3.selectAll(".checkboxes").on("click", function(d) {
      ...
      d3.selectAll(".checkboxes").each(function(d,i){
